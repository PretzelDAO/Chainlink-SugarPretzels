...
To connect the NFT experience with the real-world we rely on ChainLink Oracles to supply external data. For our current concept, we are using the [Google Weather Oracle](https://docs.chain.link/docs/google-weather/) provided by ChainLink. We are starting with weather because, as any experienced baker will tell you, weather plays an important role in how the dough reacts during baking. For that we are making use of the Brownie Framework.
...
Sugar Pretzels is a project coming out of the bakery at **[PretzelDAO](https://www.pretzeldao.com/)**. PretzelDAO is a community of builders baked in Munich at home in Web3
